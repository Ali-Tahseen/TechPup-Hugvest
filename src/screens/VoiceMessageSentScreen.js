...
const VoiceMessageSentScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bottomContainer}>
        <Text style={styles.title}>Voice Message Sent!</Text>
        <Text style={styles.subtitle}>{dogData.name} has received your voice message</Text>
